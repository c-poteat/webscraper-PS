...
$from = "someone@mail.com" #used mail.com setting since gmail and yahoo mail do not allow less secure connections
$to = "someone@gmail.com"  #replace with actual gmail address
...
$username = "yourusername@mail.com"  #again signed up to mail.com
